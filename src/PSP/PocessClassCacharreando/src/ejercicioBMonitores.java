...
Uno de ellos debe sumar los números pares de 1 al 100; otro los impares, y otro los que terminen en 2 o en 3.
Posible salida:
Inicio
...
public class ejercicioBMonitores {
    ...
    static class Sumador implements Runnable {
        ...
        public void run() {
            ...
            synchronized (lock) { // Sincronizamos el acceso a la consola
...
Al igual que en el ejemplo anterior, se usa un objeto de monitor (lock)
para garantizar que solo un hilo imprima a la vez en la consola.
Cada hilo calcula la suma de los números correspondientes según su tipo
 */